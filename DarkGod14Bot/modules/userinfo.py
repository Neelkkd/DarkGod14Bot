...
from DarkGod14Bot.__main__ import STATS, GDPR, TOKEN, USER_INFO
import DarkGod14Bot.modules.sql.userinfo_sql as sql
...
from DarkGod14Bot.modules.sql.afk_sql import is_afk, check_afk_status
from DarkGod14Bot.modules.sql.users_sql import get_user_num_chats
from DarkGod14Bot.modules.sql.clear_cmd_sql import get_clearcmd
from DarkGod14Bot.modules.helper_funcs.chat_status import sudo_plus
from DarkGod14Bot.modules.helper_funcs.extraction import extract_user
from DarkGod14Bot.modules.helper_funcs.misc import delete
from DarkGod14Bot import telethn as DarkGod14BotTelethonClient, SUDO_USERS, SUPPORT_USERS
...
def info(update: Update, context: CallbackContext):
    ...
    if god_mode_level_present:
         text += ' [<a href="https://t.me/DarkGod14BotChannel/5">?</a>]'.format(
             bot.username)
...
def gdpr(update: Update, context: CallbackContext):
    ...
    update.effective_message.reply_text("Your personal data has been deleted.\n\nNote that this will not unban "
                                        "you from any chats, as that is telegram data, not DarkGod14Bot data. "
