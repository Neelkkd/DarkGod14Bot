...
from DarkGod14Bot import telethn as bot
from DarkGod14Bot.modules.urluploader import download_file
from DarkGod14Bot.utils.uputils import humanbytes, progress
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                ...
                dosya,
                force_document=True,
                caption=f"Uploaded By @DarkGod14Bot",
            )
        except Exception as e:
            traceback.print_exc()
