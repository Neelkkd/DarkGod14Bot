...
from DarkGod14Bot import telethn as DarkGod14BotTelethonClient
from DarkGod14Bot.modules.sql.clear_cmd_sql import get_clearcmd
from DarkGod14Bot.modules.helper_funcs.telethn.chatstatus import user_is_admin
from DarkGod14Bot.modules.helper_funcs.misc import delete


@DarkGod14BotTelethonClient.on(events.NewMessage(pattern=f"^[!/]zombies ?(.*)"))
