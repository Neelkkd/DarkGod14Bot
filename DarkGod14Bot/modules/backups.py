...
import DarkGod14Bot.modules.sql.notes_sql as sql
from DarkGod14Bot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from DarkGod14Bot.__main__ import DATA_IMPORT
from DarkGod14Bot.modules.helper_funcs.chat_status import user_admin
from DarkGod14Bot.modules.helper_funcs.alternate import typing_action

# from DarkGod14Bot.modules.rules import get_rules
import DarkGod14Bot.modules.sql.rules_sql as rulessql

# from DarkGod14Bot.modules.sql import warns_sql as warnssql
import DarkGod14Bot.modules.sql.blacklist_sql as blacklistsql
from DarkGod14Bot.modules.sql import disable_sql as disabledsql

# from DarkGod14Bot.modules.sql import cust_filters_sql as filtersql
# import DarkGod14Bot.modules.sql.welcome_sql as welcsql
import DarkGod14Bot.modules.sql.locks_sql as locksql
from DarkGod14Bot.modules.connection import connected
...
def export_data(update: Update, context: CallbackContext):
    ...
    with open("DarkGod14Bot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("DarkGod14Bot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `DarkGod14Bot-Backup` was specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("DarkGod14Bot{}.backup".format(chat_id))  # Cleaning file
